...
class AdminNilaiMahasiswaService
{
    /**
     * Get prodi_id milik Admin yang sedang login.
     */
     ...
     * Scoped to Admin's own prodi — no prodi_id filter needed from request.
     *
    ...
    public function getNilaiMahasiswaList(array $filters = [], int $perPage = 10, ?string $search = null): array
    {
        ...
        $query = AkademikMahasiswa::query()
            ...
            ->where('mahasiswa.prodi_id', $prodiId)                          // ← scope Admin
