...
use App\Services\Dekan\TindakLanjutProdiService;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use App\Exports\TindakLanjutExport;

/**
 * @tags Dekan - Tindak Lanjut Prodi
 */
    ...
    public function getCardSummary()
    {
        try {
            ...
            return $this->successResponse(
                $dataGabungan,
                'Data statistik tindak lanjut per Prodi berhasil diambil'
            );
        } catch (\Exception $e) {
