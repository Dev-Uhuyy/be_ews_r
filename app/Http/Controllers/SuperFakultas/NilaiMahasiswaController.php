...
use App\Services\SuperFakultas\NilaiMahasiswaService;

/**
 * @tags SuperFakultas - Nilai Mahasiswa
 */
class NilaiMahasiswaController extends Controller
{
     ...
     *
     * Contoh:
     * - GET /api/ews/super-fakultas/nilai-mahasiswa?prodi_id=1
     * - GET /api/ews/super-fakultas/nilai-mahasiswa?has_nilai_e=true
     * - GET /api/ews/super-fakultas/nilai-mahasiswa?tahun_masuk=2023&mk_nasional_kurang=true
     * - GET /api/ews/super-fakultas/nilai-mahasiswa?mahasiswa_id=5 (single mahasiswa)
     *
     * @tags SuperFakultas - Nilai Mahasiswa
     */
