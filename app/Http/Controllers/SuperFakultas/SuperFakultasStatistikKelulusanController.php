...
use App\Services\SuperFakultas\StatistikKelulusanService;

/**
 * @tags SuperFakultas - Statistik Kelulusan
 */
class SuperFakultasStatistikKelulusanController extends Controller
{
